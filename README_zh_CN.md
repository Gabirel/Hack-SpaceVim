...
如果你在使用SpaceVim的时候遇到了任何功能性错误，请在[SpaceVim:issue-tracker](https://github.com/spacevim/spacevim/issue/)下提交一个issue来帮助您解决的问题。 
...
Vim新人: [vim-galore](https://github.com/mhinz/vim-galore)

官方SpaceVim: [SpaceVim/SpaceVim](https://github.com/spacevim/spacevim)
